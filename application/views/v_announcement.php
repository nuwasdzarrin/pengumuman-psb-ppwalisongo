...
<head>
	...
	<!-- Favicons -->
	<link href="/assets/images/icon-ppws.png" rel="icon">
	<link href="/assets/images/icon-ppws.png" rel="apple-touch-icon">
...
<!--		<h1 class="logo">-->
<!--			<a href="/">-->
<!--				<img src="/assets/images/logoppwalisongo.png" style="height: 50px;width: auto">-->
<!--			</a>-->
<!--		</h1>-->
		<!-- Uncomment below if you prefer to use an image logo -->
		 <a href="index.html" class="logo"><img src="/assets/images/logoppwalisongo.png" alt="" class="img-fluid"></a>
